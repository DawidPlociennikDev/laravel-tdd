...
class MovieControllerTest extends TestCase
{
    ...
    public function test_user_can_see_list_of_movies(): void
    {
        $this->get(route('movies.index'))
            ->assertOk()
            ->assertJsonStructure([
                ['name', 'director', 'release_year', 'cover', 'description']
            ]);
    }
    ...
    public function test_user_can_see_a_single_movie(): void
    {
        ...
        $this->get(route('movies.show', ['movie' => $movie->id]))
            ->assertOk()
            ->assertJsonStructure(['id', 'name', 'director', 'release_year', 'cover', 'description']);
    }
    ...
    public function test_user_can_edit_existing_movie(): void {
        ...
        $this->patch(route('movies.update', ['movie' => $movie->id]), [
            'name' => 'Avatar',
        ...
        $this->assertDatabaseHas('movies', ['id' => $movie->id, 'name' => 'Avatar']);
    }
}
